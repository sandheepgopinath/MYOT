...
export default function Personalize({ scrollY }: { scrollY: number }) {
  ...
  return (
    <section
      id="personalize"
      className="fixed inset-0 text-text-primary flex flex-col items-center px-4 pt-16 sm:pt-20 lg:pt-24"
    ...
    >
      <div className="w-full max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6">
          {/* Custom Studio - First */}
          <div className="glass-card p-4 md:p-6 lg:p-8 flex flex-col justify-end min-h-[200px] sm:min-h-[250px] lg:min-h-[380px] relative overflow-hidden cursor-pointer">
            <Image
              src="/personalize.png"
              alt="Custom Studio"
              fill
            ...
            <div className="relative z-10">
              <h4 className="font-display text-xl md:text-2xl lg:text-3xl mb-2 font-normal text-white">
                Custom Studio
              </h4>
